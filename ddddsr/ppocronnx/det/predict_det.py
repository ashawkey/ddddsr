...
import logging
from ddddsr.ppocronnx.utility import get_model_data
...
class TextDetector(object):
    def __init__(self, providers):
        ...
        self.postprocess_op = DBPostProcess(thresh=0.3, box_thresh=0.5, max_candidates=1000, unclip_ratio=2,
                                            use_dilation=True)
        sess = ort.InferenceSession(get_model_data(model_file), providers=providers)
